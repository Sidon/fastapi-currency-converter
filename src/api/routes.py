...
TEXT_FROM = (
    f"Moeda da qual deseja converter, por exemplo, USD. [Symbolos ISO]({URL_4217})"
)
TEXT_TO = (
    f"Moeda para a qual deseja converter, por exemplo, BTC. [Symbolos ISO]({URL_4217})"
)
...
async def convert(
    from_currency: str = Query(
        ..., description=TEXT_FROM, example="USD", values=CURRENCY_CODES
    ),
    to_currency: str = Query(
        ..., description=TEXT_TO, example="BTC", values=CURRENCY_CODES
    ),
